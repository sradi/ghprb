    ...
    public static final class DescriptorImpl extends TriggerDescriptor {
        ...
        public boolean configure(StaplerRequest req, JSONObject formData) throws FormException {
            ...
            if (formData.has("credential")) {
                ...
                credentials.add(new GhprbGithubCredentials("default", formData.getString("serverAPIUrl"), formData.getString("username"), formData.getString("password"), formData
                        .getString("accessToken"), formData.getString("publishedURL"), false));
            }
